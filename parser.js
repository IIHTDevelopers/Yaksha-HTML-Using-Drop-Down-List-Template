...
const htmlTagsTestCase = {
    ...
    extraParams: [['html', 'body', 'title', 'h1', 'form', 'input', 'label', 'select']]
};
...
const htmlFormNestedTagsWithAttributesPresenceTestCase = {
    testCaseName: 'Nested Tags with Inner Attributes Presence Test',
    testCaseType: 'boundary',
    testLogic: checkNestedTagsWithInnerAttributesPresence,
    extraParams: ['form', 'select', ['name']]
};

const htmlSelectNestedTagsWithAttributesPresenceTestCase = {
    testCaseName: 'Nested Tags with Inner Attributes Presence Test',
    testCaseType: 'boundary',
    testLogic: checkNestedTagsWithInnerAttributesPresence,
    extraParams: ['select', 'option', ['value']]
};
...
function executeAllTestCases() {
    ...
    handleTestCase(filePath, htmlFormNestedTagsWithAttributesPresenceTestCase.testCaseName, htmlFormNestedTagsWithAttributesPresenceTestCase.testCaseType, htmlFormNestedTagsWithAttributesPresenceTestCase.testLogic, htmlFormNestedTagsWithAttributesPresenceTestCase.extraParams);
    handleTestCase(filePath, htmlSelectNestedTagsWithAttributesPresenceTestCase.testCaseName, htmlSelectNestedTagsWithAttributesPresenceTestCase.testCaseType, htmlSelectNestedTagsWithAttributesPresenceTestCase.testLogic, htmlSelectNestedTagsWithAttributesPresenceTestCase.extraParams);
}
